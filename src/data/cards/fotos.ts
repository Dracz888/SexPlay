...
export const fotos = deck(
  ...
  [
    ...
    [3, 'Tómale a {pareja} tres fotos: una vestid{p}, una en ropa interior y una sin nada de cintura para arriba.'],
    ...
    [4, 'Tómale una foto a {pareja} desnud{p} y déjal{p} que decida si se queda o se borra.'],
    [4, 'Graba diez segundos de video de {pareja} diciéndote al oído lo que quiere que le hagas.', { tags: ['fotos.video'] }],
    [4, 'Tómale una foto a {pareja} mientras l{p} tocas, con su cara fuera del encuadre.'],
