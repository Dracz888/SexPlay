...
export const sexo = deck(
  ...
  [
    ...
    [2, 'Pregúntale a {pareja} qué es lo que más le gusta del momento exacto en que l{p} penetras.', { actorGender: 'hombre' }],
  ...
  [
    ...
    [3, 'Ponte encima de {pareja} y muévete como si l{p} estuvieras penetrando, pero sin quitarse la ropa interior.'],
    ...
    [4, 'Penetra a {pareja} en la postura que elija durante un minuto.', { actorGender: 'hombre' }],
    [4, 'Cójanse de pie, contra la pared.'],
    [4, 'Que {pareja} se ponga encima y lleve el ritmo durante un minuto.'],
    [4, 'Cójanse de cucharita, muy despacio, mientras l{p} acaricias por delante.'],
    [4, 'Penetra a {pareja} desde atrás agarrándole el pelo.', { actorGender: 'hombre' }],
    [4, 'Cambien de postura cada treinta segundos durante dos minutos.'],
    [5, 'Penétral{p} mirándol{p} a los ojos, sin apartar la mirada ni un segundo.', { actorGender: 'hombre' }],
    [5, 'Lléval{p} al borde y para. Repítelo hasta que te ruegue que l{p} dejes acabar.', { tags: ['sexo.control_orgasmo'] }],
    [5, 'Cójanse hasta que {pareja} acabe. Después le toca decidir qué haces tú.'],
    [5, 'Acaba sobre el cuerpo de {pareja}, donde te diga.', { tags: ['sexo.acabar_cuerpo'], actorGender: 'hombre' }],
