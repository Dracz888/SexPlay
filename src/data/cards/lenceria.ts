...
export const lenceria = deck(
  ...
  [
    ...
    [2, 'Pregúntale a {pareja} si se puso esa ropa interior pensando en que l{p} vieras hoy.'],
    [3, 'Pregúntale a {pareja} qué lencería le gustaría verte puesta. Que sea concret{p}.'],
    ...
    [4, 'Pregúntale a {pareja} qué se pondría para ti si supiera que nadie más se la va a ver nunca.'],
  ...
  [
    ...
    [2, 'Que {pareja} se quede sol{p} en ropa interior el resto de la partida.'],
    ...
    [4, 'Que {pareja} se quede sol{p} con la ropa interior puesta y tú se la vas rompiendo o corriendo con las manos.'],
    [4, 'Ponte la ropa de {pareja} y déjal{p} que te la quite.', { tags: ['lenceria.cruzada'] }],
    ...
    [5, 'Desnuda a {pareja} del todo y quédate tú vestid{a}. Tócal{p} así durante dos minutos.'],
  ],
);
