...
export const lugares = deck(
  'lugares',
  [
    [1, 'Pregúntale a {pareja} en qué parte de la casa nunca lo han hecho y le gustaría.'],
    [2, 'Pregúntale a {pareja} cuál ha sido el lugar más arriesgado donde ha tenido sexo.'],
    [2, 'Pregúntale a {pareja} si le da morbo que alguien pueda escucharlos.'],
    [3, 'Pregúntale a {pareja} qué le haría ahora mismo si estuvieran en la cocina y hubiera gente en la sala.'],
    [3, 'Pregúntale a {pareja} si alguna vez ha hecho algo en un carro. Que cuente todo.'],
  ...
  [
    [1, 'Váyanse los dos a otra habitación de la casa y bésense ahí durante un minuto.'],
    ...
    [4, 'Hazle sexo oral a {pareja} en la ducha.', { tags: ['oral'] }],
    [4, 'Váyanse al carro y quédense ahí los próximos dos turnos.', { tags: ['lugares.exterior'] }],
